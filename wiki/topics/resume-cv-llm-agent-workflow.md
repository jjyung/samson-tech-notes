...
- [持久化 Wiki 與 RAG 的差異](../concepts/persistent-wiki-vs-rag.md)：知識先被整理成可維護資產
- [工程化讓 AI 輸出更穩定](../concepts/engineering-stabilizes-ai-output.md)：用流程壓低模型波動
- [Query 即知識生產](query-as-knowledge-production.md)：高價值結果可以回寫成長期頁面
- [Ingest 工作流](ingest-workflow.md)：來源應該先被整理，再進入知識層
...
- [履歷證據庫](../concepts/resume-evidence-base.md)
- [履歷 JD Mapping](../concepts/resume-jd-mapping.md)
- [履歷 QA Gate](../concepts/resume-qa-gate.md)
- [履歷量化追問](../concepts/resume-quantitative-follow-up.md)
- [ATS 友善輸出](../concepts/ats-friendly-output.md)
